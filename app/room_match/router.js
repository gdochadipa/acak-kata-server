...
const { createRoom, searchingRoomWithCode, confirmGame, getPackageQuestion, saveScoreMatch, getResultMatch, findRoomWithRoomCode, findRoomByID, testSchedule, onDisconnectRoom, disconnectFromRoom} = require('./controller');
